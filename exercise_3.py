...
if __name__ == "__main__":
    ...
    if args.load:
        ...
        # Third block: Expeirmental results
        result_root = "exercise1.3_finalpart_results"
        images_to_show = [
            "final_alpha.png", 
            "medium_sized_alpha.png", 
            "small_alpha.png", 
            "very_small_alpha.png"
        ]

        print(f"Displaying results from {result_root}...")
        
        PLT.figure(figsize=(16, 4))
        for i, img_name in enumerate(images_to_show):
            img_path = os.path.join(result_root, img_name)
